 ...
 *
 * $Id: util.c,v 1.1.1.1 2002/08/26 14:14:50 ben Exp $
 */
...
#  include <zlib.h>
# else
static int compress2(unsigned char *a, unsigned long *b,
	      unsigned char const *c, unsigned long d, int e)
{
  return -1;
}
static int uncompress(unsigned char *a, unsigned long *b,
	       unsigned char const *c, unsigned long d)
{
  return -1;
}	       
