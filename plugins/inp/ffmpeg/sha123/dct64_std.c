...
extern real * sha123_pnts[];

static void sha123_dct64_std(real * out0, real * out1, const real * samples)
{
  real bufs[64];

  {
    register int i, j;
    const register real *b1, *b2;
    register real *bs;
    const register real * costab;

    b1 = samples;
    bs = bufs;
    costab = sha123_pnts[0] + 16;
    b2 = b1 + 32;
...
sha123_dct_info_t sha123_dct64_std_info = {
  "FPU dct-64",
