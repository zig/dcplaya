...
static AVCodec mpeg4_decoder = {
    ...
    decode_end,
    decode_frame,
    /*CODEC_CAP_DRAW_HORIZ_BAND | */CODEC_CAP_DR1 | CODEC_CAP_TRUNCATED | 0, 
...
int codec_main()
{
  ...
  printf("xvid codec initialising ...\n");

  param.version = XVID_VERSION;
  param.cpu_flags = 0;
  param.debug = 0;

  res = xvid_global(NULL, XVID_GBL_INIT, &param, NULL);
