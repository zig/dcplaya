...
$Id: mikmod.h,v 1.1 2002-09-21 09:53:43 benjihan Exp $
...
#define UF_PANNING		0x0400 /* module uses panning effects or have
  ...
  MIKMODAPI extern struct MLOADER* MikMod_FirstLoader(void); /* $$$ Added by ben */
  ...
  MIKMODAPI extern UWORD   Player_GetPosition(void); /* $$$ added by ben */
