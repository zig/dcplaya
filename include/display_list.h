 ...
 * @version   $Id: display_list.h,v 1.6 2002-11-27 09:58:09 ben Exp $
 */
 ...
 *  @{
 */
#define DL_MODE_PARENT 0 /**< effective = parent       */
#define DL_MODE_LOCAL  1 /**< effective = local        */
#define DL_MODE_ADD    2 /**< effective = parent+local */
#define DL_MODE_MUL    3 /**< effective = parent*local */
/**@}*/
...
typedef struct dl_list {
  ...
  struct {
	...
	int trans_herit:2;         /**< Transformation heritage operation. */
	int color_herit:2;         /**< Color heritage operation.          */
  } flags;
...
/** Initialize the display list library. */
int dl_init(void);

/** Shutdown the display list library. */
...
/** @name Display list command function.
 *  @ingroup dcplaya_draw
 *
