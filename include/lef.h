 ...
 *
 * @version $Id: lef.h,v 1.4 2002-09-12 17:57:31 ben Exp $
 */
...
/** Load a LEF library.
 *
 *  @param  fd   Binary opened file descriptor on valif .lef file.
 *
 *  @warning  The lef_load() function close the file descriptor for you.
 */
