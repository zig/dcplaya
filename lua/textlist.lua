...
---
--- $Id: textlist.lua,v 1.12 2002-10-30 19:59:30 benjihan Exp $
---
...
function textlist_create(flparm)
	...
	function textlist_set_color(fl,a,r,g,b)
		local dl,a2,r2,g2,b2
		dl = fl.dl
		if dl then
			a2,r2,g2,b2 = dl_get_color(dl)
			a2 = a or a2
			r2 = r or r2
			g2 = g or g2
			b2 = b or b2
			dl_set_color(dl,a2,r2,g2,b2)
		end
		dl = fl.cdl
		if dl then
			a2,r2,g2,b2 = dl_get_color(dl)
	...
	function textlist_draw_list(fl)
		...
		for i=fl.top+1, max, 1 do
			fl:draw_entry(fl.dl, i, fl.border, y, 0.1)
